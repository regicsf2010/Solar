...
public class ChromosomeSchafferN4 extends Chromosome {
	...
	public static ChromosomeSchafferN4 createEmptyChromosome(int nGenes) {
		return new ChromosomeSchafferN4(new double[nGenes], new double[NOBJECTIVES]);
	}
}
